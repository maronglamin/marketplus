...
type VehicleManagementScreenNavigationProp = NativeStackNavigationProp<AppStackParamList, 'VehicleManagement'>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.comingSoonContainer}>
          ...
          <Text style={styles.comingSoonTitle}>Vehicle Management</Text>
          <Text style={styles.comingSoonText}>
            Vehicle management features are coming soon. You'll be able to manage your vehicle information, documents, and maintenance records.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
