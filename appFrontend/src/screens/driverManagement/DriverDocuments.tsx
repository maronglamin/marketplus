...
type DriverDocumentsScreenNavigationProp = NativeStackNavigationProp<AppStackParamList, 'DriverDocuments'>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.comingSoonContainer}>
          ...
          <Text style={styles.comingSoonTitle}>Driver Documents</Text>
          <Text style={styles.comingSoonText}>
            Document management features are coming soon. You'll be able to upload, view, and manage your driver license, insurance, and other required documents.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
