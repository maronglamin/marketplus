  ...
  const handleExportPDF = async () => {
    try {
      ...
      const htmlHead = `
        <head>
          ...
          <style>
            ...
            .header { display:flex; align-items:center; justify-content:space-between; margin-bottom: 24px; padding-bottom: 12px; border-bottom: 1px solid #E5E7EB; }
      ...
      const html = `<!DOCTYPE html><html>${htmlHead}<body>
        <div class="header">
          <div class="brand">
            <img src="/assets/icon.png" alt="Company Logo" class="brand-logo" />
          </div>
        ...
        <div class="footer"><img src="/assets/icon.png" alt="Logo" class="footer-logo" /><span class="muted">Generated by Marketplace Web</span></div>
      </body></html>`;
