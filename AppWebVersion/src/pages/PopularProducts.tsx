...
import { Star, TrendingUp, RefreshCw, AlertCircle, Filter, X } from 'lucide-react';
...
export function PopularProducts() {
  ...
  const loadPopularProducts = async (isLoadMore: boolean = false) => {
    try {
      ...
      const response = await productService.getPopularProducts(currentPage, 20);
      ...
      if (isLoadMore) {
        ...
        applyCategoryFilter(response.products, selectedCategory);
        setPage(1);
        setHasMore(response.hasMore);
      }
    } catch (error: any) {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Most ordered products by customers</p>
              </div>
            </div>
        ...
        {!hasMore && products.length > 0 && (
          <div className="text-center py-8">
            <p className="text-gray-500">No more popular products to load</p>
          </div>
        )}
      </div>
    </div>
